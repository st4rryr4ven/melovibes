 ...
 * - requiresAdmin: user must have ROLE_ADMIN
 */
...
/**
 * Global navigation guard enforcing auth/admin rules.
 *
 * The guard initializes the auth store once when its status is unknown.
 */
